...
gem "dm-is-versioned",                          :git => "git://github.com/yogo/dm-is-versioned.git", 
                                                :branch => "voeis/patches"

gem "rails"                                     # Rails application (Please Keep!)
gem "activerecord", :require => "active_record" # Not sure why this is necessary (pol)
...
platforms(:ruby_19) {
  gem "therubyracer", "0.9.3beta1",             :require => "v8"
}
...
group(:development, :test) do
  gem "dm-visualizer"
  gem "rake",                                   :require => nil # Not sure why this is necessary (pol)
  ...
  gem "test-unit", "~> 1.2.1",                  # TODO: We need to find out how to remove this
                                                :require => nil 
