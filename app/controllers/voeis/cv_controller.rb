class Voeis::CVController < Voeis::BaseController
  ...
  CV_MAP = {
    ...
    :quality_control_level => {
      ...
      :cv_params => [],
      :cv_columns => [{:field=>"quality_control_level_code", :label=>"Quality Control Level", :width=>"200px", :filterable=>true, :formatter=>"", :style=>""},
                    {:field=>"definition", :label=>"Definition", :width=>"", :filterable=>true, :formatter=>"", :style=>""},
                    {:field=>"explanation", :label=>"Explanation", :width=>"", :filterable=>true, :formatter=>"", :style=>""}],
      :copy_columns => [{:field=>"quality_control_level_code", :label=>"Quality Control Level", :width=>"100px", :filterable=>true, :formatter=>"", :style=>""},
                    {:field=>"definition", :label=>"Definition", :width=>"", :filterable=>true, :formatter=>"", :style=>""},
                    {:field=>"explanation", :label=>"Explanation", :width=>"", :filterable=>true, :formatter=>"", :style=>""}],
      :cv_form => [{:field=>"id", :type=>"-IH", :required=>"", :style=>""},
                    {:field=>"idx", :type=>"-XH", :required=>"", :style=>""},
    ...
    :spatial_reference => {
      ...
      :copy_columns => [{:field=>"srs_name", :label=>"Source Name", :width=>"16%", :filterable=>true, :formatter=>"", :style=>""},
  ...
  def versions
    ...
    @cv_refs = CV_MAP[@cv_type][:cv_refs].call(@cv_versions)
