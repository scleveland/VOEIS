class Voeis::VerticalDatumCVsController < Voeis::BaseController
  ...
  def create
    ...
    @vertical_datum = parent.managed_repository{Voeis::VerticalDatumCV.with_deleted{Voeis::VerticalDatumCV.get(params[:vertical_datum_c_v][:id])}}
    if @vertical_datum.nil?
      @vertical_datum = parent.managed_repository{Voeis::VerticalDatumCV.create(:id=>params[:vertical_datum_c_v][:id],
                              :term=>params[:vertical_datum_c_v][:term],
                              :definition=>params[:vertical_datum_c_v][:definition],
                              :provenance_comment=>params[:vertical_datum_c_v][:provenance_comment])}
    else
  ...
  def update
    vertical_datum = parent.managed_repository{Voeis::VerticalDatumCV.get(params[:vertical_datum_c_v][:id])}
