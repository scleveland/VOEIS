  ...
  def show
    ...
    @sites.each{ |site| 
      ...
      site.variables.map{ |var|
        ...
        @temp_array << {:varname=>var.variable_name, :varid=>var.id, :varunits=>var.variable_units[:units_abbreviation], :vartype=>var.data_type, :count=>var_stats[0], :first=>var_stats[1], :last=>var_stats[2]}
      }
